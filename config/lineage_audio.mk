...
ALARM_PATH := vendor/pillar/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/pillar/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/pillar/prebuilt/common/media/audio/ringtones
